...
int omap_gpio_out_init( void )
{
	...
	{
		omap_set_gpio_dataout( output_gpio[i][0], output_gpio[i][1] );
		omap_set_gpio_direction( output_gpio[i][0], 0 );
	}
