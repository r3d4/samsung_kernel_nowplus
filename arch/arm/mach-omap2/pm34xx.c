...
// ]
#define __PREVENT_GPIO_GLITCH_SIDE_EFFECT__
/* Scratchpad offsets */
...
// SAMSUNG egkim [
	...
	if( wkup_st & 0x2 )  // is wakeup reason GPTIMER12?
	{
		...
		ret_val = prm_read_mod_reg( OCP_MOD, OMAP2_PRM_IRQSTATUS_MPU_OFFSET );  //MPU IRQ STATUS
		prm_write_mod_reg( ret_val, OCP_MOD, OMAP2_PRM_IRQSTATUS_MPU_OFFSET ); //CLEAR MPU IRQ
