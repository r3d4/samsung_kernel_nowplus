...
/* IVA2 -> L3 */
static struct omap_hwmod_ocp_if omap3xxx_iva__l3_main = {
	.master		= &omap3xxx_iva_hwmod,
	.slave		= &omap3xxx_l3_main_hwmod,
	.user		= OCP_USER_MPU | OCP_USER_SDMA,
};
...
static struct omap_hwmod_class_sysconfig omap3xxx_timer_gpt12_sysc = {
	        .rev_offs       = 0x0000,
	        .sysc_offs      = 0x0010,
	        .syss_offs      = 0x0014,
	        .sysc_flags     = (SYSC_HAS_CLOCKACTIVITY |
                                   SYSC_HAS_ENAWAKEUP | SYSC_HAS_SOFTRESET |
                                   SYSC_HAS_EMUFREE | SYSS_HAS_RESET_STATUS),
	        .idlemodes      =  SIDLE_NO ,
                .sysc_fields    = &omap_hwmod_sysc_type1,
};

static struct omap_hwmod_class omap3xxx_timer_gpt12_hwmod_class = {
	       .name = "earlytimer",
	       .sysc = &omap3xxx_timer_gpt12_sysc,
	       .rev = OMAP_TIMER_IP_VERSION_1,
};
...
/* l4_wkup -> timer12 */
static struct omap_hwmod_ocp_if omap3xxx_l4_wkup__timer12 = {
	.master		= &omap3xxx_l4_wkup_hwmod,
...
static struct omap_hwmod omap3xxx_timer12_hwmod = {
	...
	.prcm		= {
		.omap2 = {
			...
			.module_offs = WKUP_MOD,
			.idlest_reg_id = 1,
			.idlest_idle_bit = OMAP3430_EN_GPT12_SHIFT,
		},
	},
	...
	.class		= &omap3xxx_timer_gpt12_hwmod_class,
	.omap_chip	= OMAP_CHIP_INIT(CHIP_IS_OMAP3430)
};
