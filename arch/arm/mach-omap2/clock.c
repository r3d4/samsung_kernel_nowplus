...
long omap2_dpll_round_rate(struct clk *clk, unsigned long target_rate)
{
	...
	if (min_e < 0) {
        ...
        if(!(strcmp(clk->name,"dpll2_ck")) && target_rate==520000000)  // added as the m and n values generated was making a kernel Crash
        {
        //printk("\n Vdd1_opp for iva and 520Mhz\n");
        dd->last_rounded_m = 520;
        dd->last_rounded_n = 13;
        }
        else
        {
        //printk("default code for m & n configuration\n");
