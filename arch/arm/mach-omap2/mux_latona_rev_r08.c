...
unsigned int output_gpio[][2] = {
       {OMAP_GPIO_TOUCH_EN, 0,"touch_atmel"},
};
 ...
 */
	...
	OMAP3_MUX(GPMC_A10, OMAP_MUX_MODE4 | OMAP_PIN_INPUT_PULLUP),
	// 49 
	...
	OMAP3_MUX(GPMC_NBE0_CLE,  OMAP_MUX_MODE4 | OMAP_PIN_INPUT_PULLUP),
	...
	// 129 (B26, L, GPIO_111, PDA_ACTIVE) // 9/26 wonhee48.seo
	OMAP3_MUX(CAM_XCLKB,  OMAP_MUX_MODE4 | OMAP_PIN_INPUT_PULLUP),
	...
	OMAP3_MUX(GPIO128,	OMAP_MUX_MODE4 | OMAP_PIN_INPUT),//jyothi
	...
	// 174 (AD2, L, GPIO_154, PHONE_ACTIVE) // 9/26 wonhee48.seo
	...
	// 216 (H11, H, GPIO_181, IPC_SRDY, 0) // 09/17 sd2.lee
	OMAP3_MUX(MCSPI2_CS0,  OMAP_MUX_MODE4 | OMAP_PIN_INPUT_PULLDOWN),
	// 217 (J11, L, GPIO_182, IPC_MRDY, 0) // 09/17 sd2.lee
	OMAP3_MUX(MCSPI2_CS1, OMAP_MUX_MODE4 | OMAP_PIN_INPUT_PULLDOWN),
	...
	OMAP3_MUX(ETK_D2,  OMAP_MUX_MODE4 | OMAP_PIN_INPUT_PULLUP), //EXTERNAL PULL-UP
...
//unsigned int OMAP_pins_size = OMAP_PINS_SZ;
//struct pin_config *OMAP_pins_ptr;

//EXPORT_SYMBOL(OMAP_pins_size);
