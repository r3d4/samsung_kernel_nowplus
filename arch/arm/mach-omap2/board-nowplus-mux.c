...
OMAP3_MUX(GPMC_NCS7,             OMAP34XX_MUX_MODE7 | OMAP34XX_PIN_INPUT_PULLUP),
        ...
        //"TOUCH I2C SCL"
        OMAP3_MUX(I2C3_SCL,             OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT | OMAP34XX_PIN_OFF_INPUT),
        //"TOUCH I2C SDA"
        OMAP3_MUX(I2C3_SDA,             OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT | OMAP34XX_PIN_OFF_INPUT),
        ...
        //"TVOUT SEL" gpio_177
        OMAP3_MUX(MCSPI1_CS3,           OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT| OMAP34XX_PIN_OFF_OUTPUT_HIGH),
...
// reboot fail workaround:
// there seems to be an glitch on gpio at reboot, prevents device from rebooting
// so instead of use GPIO set output value with pullup/-down
        OMAP3_MUX(ETK_D11,                      OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLUP | OMAP34XX_PIN_OFF_INPUT_PULLUP),
        //"EARKEY DETECT"
