...
void omap_dma_suspend(int lch)
{
        omap_dma_suspend_reg.dma_ccr=dma_read(CCR(lch));
        omap_dma_suspend_reg.dma_csdp=dma_read(CSDP(lch));
        omap_dma_suspend_reg.dma_cen=dma_read(CEN(lch));
        omap_dma_suspend_reg.dma_cfn=dma_read(CFN(lch));
        omap_dma_suspend_reg.dma_cssa=dma_read(CSSA(lch));
        omap_dma_suspend_reg.dma_csei=dma_read(CSEI(lch));
        omap_dma_suspend_reg.dma_csfi=dma_read(CSFI(lch));
        omap_dma_suspend_reg.dma_csac=dma_read(CSAC(lch));
        omap_dma_suspend_reg.dma_cdac=dma_read(CDAC(lch));
        omap_dma_suspend_reg.dma_clnk_ctrl=dma_read(CLNK_CTRL(lch));
        omap_dma_suspend_reg.dma_cicr=dma_read(CICR(lch));
        omap_dma_suspend_reg.dma_csr=dma_read(CSR(lch));
        omap_dma_suspend_reg.dma_cdsa=dma_read(CDSA(lch));
        omap_dma_suspend_reg.dma_cdei=dma_read(CDEI(lch));
        omap_dma_suspend_reg.dma_cdfi=dma_read(CDFI(lch));
        omap_dma_suspend_reg.dma_ccen=dma_read(CCEN(lch));
        omap_dma_suspend_reg.dma_ccfn=dma_read(CCFN(lch));
}
EXPORT_SYMBOL(omap_dma_suspend);

void omap_dma_resume(int lch)
{
        dma_write(omap_dma_suspend_reg.dma_ccr,CCR(lch));
        dma_write(omap_dma_suspend_reg.dma_csdp,CSDP(lch));
        dma_write(omap_dma_suspend_reg.dma_cen,CEN(lch));
        dma_write(omap_dma_suspend_reg.dma_cfn,CFN(lch));
        dma_write(omap_dma_suspend_reg.dma_cssa,CSSA(lch));
        dma_write(omap_dma_suspend_reg.dma_csei,CSEI(lch));
        dma_write(omap_dma_suspend_reg.dma_csfi,CSFI(lch));
        dma_write(omap_dma_suspend_reg.dma_csac,CSAC(lch));
        dma_write(omap_dma_suspend_reg.dma_cdac,CDAC(lch));
        dma_write(omap_dma_suspend_reg.dma_clnk_ctrl,CLNK_CTRL(lch));
        dma_write(omap_dma_suspend_reg.dma_cicr,CICR(lch));
        dma_write(omap_dma_suspend_reg.dma_csr,CSR(lch));
        dma_write(omap_dma_suspend_reg.dma_cdsa,CDSA(lch));
        dma_write(omap_dma_suspend_reg.dma_cdei,CDEI(lch));
        dma_write(omap_dma_suspend_reg.dma_cdfi,CDFI(lch));
        dma_write(omap_dma_suspend_reg.dma_ccen,CCEN(lch));
        dma_write(omap_dma_suspend_reg.dma_ccfn,CCFN(lch));
}
EXPORT_SYMBOL(omap_dma_resume);
