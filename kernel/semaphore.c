...
/*
sem_debug_free_head & sem_debug_done_head may be needed.
*/
typedef struct {
...
sem_debug_t sem_debug_free_head;
sem_debug_t sem_debug_done_head;
int sem_debug_free_head_cnt=0;
int sem_debug_done_head_cnt=0;
int sem_debug_init = 0;

void debug_for_semaphore_init(void)
{
    int i =0;
    sem_debug_t * sem_debug =  NULL;
    ...
    {
        // malloc semaphore
        sem_debug  = kmalloc(sizeof(sem_debug_t), GFP_KERNEL);
        // add list
...
// klaatu semaphore debug
    ...
    if( sem_debug_init )
    {
        ...
        {
            sem_dbg = list_entry(tmp, sem_debug_t, list);
