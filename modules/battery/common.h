...
#define DEFAULT_CHARGING_TIMEOUT        6 * 60 * 60                 // 5 hours (18000 sec)
#define DEFAULT_RECHARGING_TIMEOUT        1.5 * 60 * 60                 // 2 hours (18000 sec)
#define CHARGE_STOP_TEMPERATURE_MAX		63
#define CHARGE_STOP_TEMPERATURE_MIN		-5
#define CHARGE_RECOVER_TEMPERATURE_MAX		58
#define CHARGE_RECOVER_TEMPERATURE_MIN		 0
#define CHARGE_RECHG_VOLTAGE			4250
...
#define CHARGE_STOP_TEMPERATURE_MAX		62 
#define CHARGE_STOP_TEMPERATURE_MIN		-5
#define CHARGE_RECOVER_TEMPERATURE_MAX		57
#define CHARGE_RECOVER_TEMPERATURE_MIN		 0
#define CHARGE_RECHG_VOLTAGE			4120
...
#define CHARGE_RECHG_VOLTAGE			4090
#endif
