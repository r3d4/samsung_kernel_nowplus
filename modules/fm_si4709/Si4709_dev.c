...
int Si4709_dev_powerup(void)
{
	...
	SYSCONFIG2_BITSET_VOLUME(&Si4709_dev.registers[SYSCONFIG2],0x0F);   //  -0dBFS
   ...
   //SYSCONFIG3_BITSET_VOLEXT_ENB(&Si4709_dev.registers[SYSCONFIG3]); // 1=attenuates the output by 30dB
