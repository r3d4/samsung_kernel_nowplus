...
// DDR Addr : 0x8000000, DDR Size : 256M(0x10000000), Onedram A,B bank Size : 80M(0x5000000)
//#define DPRAM_START_ADDRESS_PHYS 		0x90000000
// DDR Addr : 0x8000000, DDR Size : 128M(0x8000000), Onedram A,B bank Size : 80M(0x5000000)
#if (CONFIG_SAMSUNG_REL_HW_REV >= ARCHER_REV13)
#define DPRAM_START_ADDRESS_PHYS 		0x90000000
#else
#define DPRAM_START_ADDRESS_PHYS 		0x88000000
#endif
...
#define MAX_DEFAULT_NV_SIZE			0x200000	// 2 * 1024 * 1024
