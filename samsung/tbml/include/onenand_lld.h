...
typedef struct {
    ...
    INT32 (*dev_info)		(UINT32 nDev,  LLDSpec *pstDevInfo);
    INT32 (*check_bad)		(UINT32 nDev,  UINT32 Pbn);
    INT32 (*flush)			(UINT32 nDev); 
    INT32 (*set_rw)			(UINT32 nDev,  UINT32 nSUbn,   UINT32 nUBlks);
    INT32 (*ioctl)			(UINT32 nDev,  UINT32 nCmd,
							UINT8 *pBufI, UINT32 nLenI,
							UINT8 *pBufO, UINT32 nLenO,
							UINT32 *pByteRet);

    VOID  (*platform_info)	(LLDPlatformInfo*   pstLLDPlatformInfo);
} lld_ftable;
