...
/*   05-AUG-2003 [SongHo Yoon]: added nNumOfUsBlks into tbml_vol_spec structure */
...
/*                                tbml_vol_spec structure (UINT16->UINT32)      */
...
/*****************************************************************************/
/* maximum nSizeOfData of part_exinfo structure                                 */
/*****************************************************************************/
...
/*****************************************************************************/
#if !defined(XSR_NBL2)
INT32   BML_Format           (UINT32  nVol,  part_info *pstPart, UINT32 nFlag);
#endif /* XSR_NBL2 */

/*****************************************************************************/
/* Major APIs                                                                */
/*****************************************************************************/
INT32   tbml_init             (VOID);
INT32   tbml_open             (UINT32  nVol);

INT32   tbml_close            (UINT32  nVol);
INT32   tbml_read             (UINT32  nVol,  UINT32  nVsn,  UINT32 nNumOfScts,
                              UINT8  *pMBuf, UINT8  *pSBuf, UINT32 nFlag);
INT32   tbml_mread            (UINT32  nVol,  UINT32 nVsn,   UINT32 nNumOfScts,
                              UINT8  *pMBuf, UINT8 *pSBuf,  UINT32 nFlag);
INT32   tbml_sgl_read          (UINT32  nVol,  UINT32 nVsn,   UINT32 nNumOfScts,
                              SGL   *pstSGL, UINT8 *pSBuf,  UINT32 nFlag);
INT32   tbml_flush          (UINT32  nVol,  UINT32   nFlag);

INT32   tbml_get_vol_spec       (UINT32  nVol,  tbml_vol_spec  *pstVolSpec);
INT32   tbml_load_partition      (UINT32  nVol,  UINT32 nID,
                              XSRPartEntry  *pstPartEntry);
INT32	tbml_get_dev_spec		 (UINT32  nVol, LLDSpec  *pstLLDSpec);                              
/*****************************************************************************/
/* Extra APIs                                                                */
/*****************************************************************************/
//INT32   BML_LoadPIExt        (UINT32  nVol,  UINT32    nID, part_exinfo *pExtInfo);
INT32   tbml_ioctl            (UINT32  nVol,  UINT32    nCode,
