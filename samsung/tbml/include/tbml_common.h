...
#ifndef _TBML_COMMON_H_
#define _TBML_COMMON_H_
...
/*****************************************************************************/
#define     NORMAL_MODE         (UINT32) 0
#define     INT_MODE            (UINT32) 1

/*****************************************************************************/
/* Global Definition which should be shared by STL, BML, FIL                 */
/*****************************************************************************/
#define		XSR_VERSION_NUMBER	150
...
#define TBML_DEBUG_LEVEL0        0
#define TBML_DEBUG_LEVEL1        1
#define TBML_DEBUG_LEVEL2        2
#define TBML_DEBUG_LEVEL3        3

#ifdef ONENAND_DEBUG
#define DEBUG(level, format, args...)                                   \
do {                                                                    \
        if (level <= DEBUG_LEVEL) {                                     \
                printk("[tbml][%s:%d]: " format "\n",                   \
