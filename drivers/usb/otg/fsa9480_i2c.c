...
static u8 MicroUSBStatus = _DETACH;
static u8 MicroJigUSBOnStatus = _DETACH;
static u8 MicroJigUSBOffStatus = _DETACH;
static u8 MicroJigUARTOnStatus = _DETACH;
static u8 MicroJigUARTOffStatus = _DETACH;
static u8 DedicatedCHGStatus = _DETACH;
static u8 USBCHGStatus = _DETACH;
u8 MicroTAstatus = _DETACH;
...
{
	if( MicroUSBStatus | MicroJigUSBOnStatus | MicroJigUSBOffStatus | DedicatedCHGStatus | USBCHGStatus)
		return 1;
	else
		return 0;
}
...
static int fsa9480_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	//gpio_direction_output(OMAP_GPIO_USBSW_NINT, 1);
