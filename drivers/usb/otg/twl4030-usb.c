...
#endif
#if defined(CONFIG_HAS_WAKELOCK) && defined(CONFIG_USB_SWITCH_FSA9480)
...
EXPORT_SYMBOL(twl4030_phy_enable);

void twl4030_phy_disable(void)
{
	struct twl4030_usb *twl = usb_transceiver;
	struct otg_transceiver x;
...
EXPORT_SYMBOL(twl4030_phy_disable);
#endif
