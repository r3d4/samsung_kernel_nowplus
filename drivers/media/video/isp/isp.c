...
void isp_set_hs_vs(int hs_vs)
{
	...
	isp_obj.config->wait_hs_vs = bufs->wait_hs_vs; //JWWON
		    ...
		    struct v4l2_pix_format *pix_output)
{
	...
	if (rval)
	{
		printk("isp_calc_pipeline failed....\n"); 
		goto out;
	}
