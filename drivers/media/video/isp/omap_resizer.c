...
mult:
	...
	ret = wait_for_completion_interruptible_timeout(&device_config->compl_isr,msecs_to_jiffies(10));      //,msecs_to_jiffies(4) //VIK_DBG RSZ_720
...
mult:
	...
	// Added time out based call so that the execution never blocks here. This solves the quick lock-unlock preview freeze problem.
	wait_for_completion_interruptible_timeout(&device_config->compl_isr,msecs_to_jiffies(10));      //,msecs_to_jiffies(4) //VIK_DBG RSZ_720
