...
static struct device_attribute led_class_attrs[] = {
	// __ATTR(hand_flash, 0666, lcd_flashlight_show, lcd_flashlight_store),
	__ATTR(hand_flash, 0664, lcd_flashlight_show, lcd_flashlight_store),
	__ATTR(lcd_gamma,  0664, lcd_gamma_show,      lcd_gamma_store),  
	__ATTR(brightness, 0644, led_brightness_show, led_brightness_store),
	__ATTR(max_brightness, 0444, led_max_brightness_show, NULL),
#ifdef SUPPORT_LCD_ACL_CTL
	__ATTR(acl_state,  0664, acl_state_show,      acl_state_store),	// ACL On/Off sysfs
#endif
...
#if 0 //Sasken - To Do check this merge is really required
/**
...
# if 0 // Sasken -To Do check really required
/**
...
void led_classdev_unregister(struct led_classdev *led_cdev)
{
	...
	device_remove_file(led_cdev->dev, &led_class_attrs[4]);
#else
	device_remove_file(led_cdev->dev, &led_class_attrs[5]);
#endif
